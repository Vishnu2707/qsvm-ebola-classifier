...
def reconstruct_ipd(
    ...
    Each record is generated by Bernoulli-sampling symptoms from the reported
    cohort frequency. This is an IPD reconstruction from summary statistics, not
    raw observed patient data, and every row carries the reconstruction method.
    """
    ...
    for label, freqs in symptom_frequencies.items():
        ...
        for i in range(n):
            ...
            for feat in feature_cols:
                record[feat] = int(rng.binomial(1, freqs[feat]))
            ...
            record["reconstruction_method"] = "IPD_from_published_frequencies"
